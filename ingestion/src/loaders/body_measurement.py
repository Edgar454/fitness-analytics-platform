...
from ingestion.src.loaders.references import get_or_create_measure_type


async def load_body_measurements(db: AsyncSession, records: list[BodyMeasurementRecord] , user_id: int) -> int:
    count = 0
    ...
    for record in records:
        ...
        ).on_conflict_do_nothing(index_elements=["user_id","measured_at", "measure_type_id"])
